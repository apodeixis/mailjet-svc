...
type Message struct {
	...
	Attributes MessageAllOfAttributes `json:"attributes"`
}
...
func NewMessage(type_ string, attributes MessageAllOfAttributes) *Message {
	this := Message{}
	this.Type = type_
...
func (o *Message) GetAttributes() MessageAllOfAttributes {
	if o == nil {
		var ret MessageAllOfAttributes
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *Message) GetAttributesOk() (*MessageAllOfAttributes, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *Message) SetAttributes(v MessageAllOfAttributes) {
	o.Attributes = v
}
